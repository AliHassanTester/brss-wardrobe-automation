...
export class ProfileSelectionPage {
    ...
    constructor(page: Page, testInfo: TestInfo) {
        ...
        // Yahan Saare Locators Combine Kar Diye Hain
        this.locators = {
            profileselection: 
            ...
            IndecoQuebecAluminiumStile: 
                    { description: 
                    "Indeco Quebec Aluminium Stile option", locator: this.page.locator("//div[text()='Indeco Quebec Aluminium Stile']") },
    ...
    public async verifyAllSystemsSwitching(): Promise<void> {
        await test.step("Verify changing all systems via dropdown", async () => {
            ...
            const stileOptions = [
                this.locators.IndecoWellingtonStile,
                this.locators.IndecoQuebecAluminiumStile,
                this.locators.DIASSoftlineGripStile,
                this.locators.IndecoSydneyStile
            ];
