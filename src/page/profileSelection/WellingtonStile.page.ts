...
export class wellingtonStilePage {
    ...
    constructor(page: Page, testInfo: TestInfo) {
        ...
        this.locators = {
            ...
            WellingtonStile: {
                description: "Wellington Stile option",
    ...
    public async wellingtonStilePage(): Promise<void> {
        await test.step("Profile selection and verify changes via screenshots", async () => {
            ...
            await this.playwrightActionsFactory.click(this.locators.WellingtonStile);
